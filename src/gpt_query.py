...
LONG_INSTRUCTION: str = "Перш ніж відповісти, глибоко вдихни і подумай крок за кроком. Перевір що відповідь містить не більше ніж 150 слів. Latex формули видавати між символами $"
